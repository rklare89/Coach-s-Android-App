...
import static android.reserver.capstone_robertklare.CleanInput.isValidPhone;
...
public class CleanInputTest {
    ...
    public void testValidPhoneNumberWithDashes() {
        ...
        boolean result = isValidPhone(validPhone);
        assertTrue(result);
    }
    ...
    public void testInvalidPhoneNumberMissingDigits() {
        ...
        boolean result = isValidPhone(invalidPhone);
        assertFalse(result);
    }
    ...
    public void testInvalidPhoneNumberNullInput() {
        ...
        boolean result = isValidPhone(nullPhone);
        assertFalse(result);
    }
    ...
    public void testInvalidPhoneNumberEmptyInput() {
        ...
        String emptyPhone = "";
        boolean result = isValidPhone(emptyPhone);
        assertFalse(result);
    }
    ...
    public void testInvalidPhoneNumberWhitespaceInput() {
        ...
        boolean result = isValidPhone(whitespacePhone);
        assertFalse(result);
    }
